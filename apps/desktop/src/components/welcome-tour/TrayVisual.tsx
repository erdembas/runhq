  ...
  return (
    <div className="relative w-full">
      ...
      <div className="border-border bg-surface-raised relative flex items-center gap-2 rounded-t-[10px] border border-b-0 px-3 py-1.5">
        <span className="text-fg-dim ml-auto text-[11px] tracking-tight">
          {i18n.t('macOS menu bar')}
        </span>
        <span
          className="bg-surface-muted border-border flex h-5 w-5 items-center justify-center rounded-md border"
          aria-label={i18n.t('RunHQ tray icon')}
        >
      ...
      <div className="border-border bg-surface-overlay rounded-b-[10px] border border-t-0 px-3 py-2">
        <div className="flex items-center justify-between text-[12px]">
          <span className="text-fg">{i18n.t('Show RunHQ')}</span>
          <span className="text-fg-dim font-mono text-[10px]">{i18n.t('click tray')}</span>
        </div>
        <div className="bg-border/60 my-1.5 h-px" />
        <div className="flex items-center justify-between text-[12px]">
          <span className="text-fg-dim">{i18n.t('Quit')}</span>
          <span className="text-fg-dim font-mono text-[10px]">{i18n.t('exits the app')}</span>
        </div>
      </div>
    </div>
  );
