...
**Workflows**, bir görevi uygulama → bağımsız inceleme → kontroller → açık onay zinciri olarak yürütür. Her iş akışı hedefini (**objective**) ve kabul ölçütünü (**acceptance**) taşır, izole bir checkout'ta çalışır ve başladığı commit'i kaydeder. Adımlar kendiliğinden ilerlemez; otomatik ilerleme isteğe bağlıdır ve sınırlıdır.
